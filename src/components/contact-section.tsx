  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setStatus("success");
        setFeedback("Thank you! An Arlington window specialist will follow up within one business day.");
      } else {
          ...
          <motion.div className={styles.contentColumn} initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            ...
            <div className={styles.contactInfo}>
              ...
              <div className={styles.contactItem}>
                ...
                <a href="mailto:contact@homewindowreplacementarlington.com" className={styles.contactValue}>contact@homewindowreplacementarlington.com</a>
              </div>
            </div>
          </motion.div>
            ...
            <form className={styles.form} onSubmit={handleSubmit}>
              ...
              <fieldset disabled={status === "submitting"} style={{ border: 'none', padding: 0, margin: 0 }}>
                ...
                <div className={styles.formGroup}>
                  ...
                  <input type="text" id="address" name="address" className={styles.formInput} placeholder="123 Main St, Arlington, TX 76011" required value={formData.address} onChange={handleChange("address")} />
