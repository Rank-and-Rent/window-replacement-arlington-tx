...
const doorTypes = [
  {
    ...
    description: 'Make a lasting first impression with premium entry doors that combine security, beauty, and energy efficiency for your Arlington home.',
    features: ['Enhanced security', 'Energy efficient', 'Customizable designs'],
    image: 'https://images.unsplash.com/photo-1617279318096-f098adb50af3?q=80&w=600',
  },
  {
    name: 'Patio Doors',
    ...
    image: 'https://images.unsplash.com/photo-1600210491369-e753d80a41f3?q=80&w=600',
  },
  {
    name: 'French Doors',
  ...
  },
  {
    ...
    description: 'Maximize space and light with contemporary sliding glass doors that glide effortlessly and create a modern aesthetic in your Arlington home.',
    features: ['Space-saving design', 'Modern appeal', 'Smooth operation'],
    image: 'https://images.unsplash.com/photo-1600573472550-8090b5e0745e?q=80&w=600',
  },
  {
    name: 'Storm Doors',
    ...
    image: 'https://images.unsplash.com/photo-1600047509358-9dc75507daeb?q=80&w=600',
  },
  {
    name: 'Custom Doors',
    ...
    <section id="doors" className={styles.section}>
      <div className={styles.container}>
        ...
        >
          ...
          <h2 className={styles.title}>Premium Door Installation for Arlington Homes</h2>
            ...
            >
              <Link href={door.slug} className={styles.cardLink}>
                <div className={styles.cardImage}>
                  <Image
                    src={door.image}
                    alt={`${door.name} installation in Arlington TX`}
                    fill
