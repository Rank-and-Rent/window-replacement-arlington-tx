...
export const metadata: Metadata = {
  ...
  description: 'Professional sliding glass door installation in Arlington, TX. Space-saving, contemporary designs with expansive glass. Andersen, Pella, JELD-WEN, Marvin. Free estimates. Call 817-592-8870.',
