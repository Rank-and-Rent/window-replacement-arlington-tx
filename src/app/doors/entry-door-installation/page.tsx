...
export const metadata: Metadata = {
  ...
  description: 'Professional entry door installation in Arlington, TX. Fiberglass, steel, and wood entry doors from top manufacturers. Enhanced security, energy efficiency, and curb appeal. Call 817-592-8870 for free estimate.',
