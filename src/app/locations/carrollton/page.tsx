...
export const metadata: Metadata = {
  ...
  description: 'Professional window replacement in Carrollton, TX. Andersen, Pella & JELD-WEN windows. Serving all Carrollton areas. Free consultation: 214-444-4444.',
