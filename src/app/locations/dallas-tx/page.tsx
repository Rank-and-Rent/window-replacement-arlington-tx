...
export const metadata: Metadata = {
  ...
  description: 'Professional window replacement in Dallas, TX. Authorized Andersen, Pella & JELD-WEN dealer. Serving all Dallas areas. Free consultation: 817-592-8870.',
