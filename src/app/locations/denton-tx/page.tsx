...
export const metadata: Metadata = {
  ...
  description: 'Expert window replacement in Denton, TX. Andersen, Pella & JELD-WEN windows. Serving all Denton areas. Free consultation: 817-592-8870.',
