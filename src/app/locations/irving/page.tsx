...
export const metadata: Metadata = {
  title: 'Window Replacement Irving TX | Professional Window Services',
  description: 'Expert window replacement in Irving, TX. Andersen, Pella & JELD-WEN authorized dealer. Serving all Irving neighborhoods. Call 214-444-4444 for free estimate.',
  keywords: 'window replacement Irving TX, Irving windows, window installation Irving, energy efficient windows Irving',
}
...
export default function IrvingPage() {
  const content = {
    ...
    services: 'Irving\'s architectural diversity—from Las Colinas luxury condos to Valley Ranch estates, from North Irving\'s established neighborhoods to South Irving\'s family-friendly communities—requires comprehensive window expertise. We handle every application: high-rise replacements coordinating with building management and HOA requirements, single-family home upgrades from single-window repairs to complete replacements, townhome renovations navigating shared-wall considerations, and new construction installations. Our selection spans all window types, from classic double-hungs maintaining traditional neighborhood character to contemporary floor-to-ceiling glass maximizing skyline views.',
    ...
    commitment: 'Irving built its reputation by attracting world-class companies through reliable infrastructure and professional services. We embrace the same commitment in window replacement—reliable scheduling that respects your time, professional installation that protects your investment, transparent pricing without hidden charges, and warranties we honor without excuses. Irving residents juggle demanding careers and busy family lives; the last thing you need is home improvement projects that create stress. We deliver smooth, professional experiences from initial consultation through final walkthrough, ensuring your window replacement enhances rather than disrupts your life.',
  }
