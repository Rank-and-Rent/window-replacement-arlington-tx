...
export const metadata: Metadata = {
  title: 'Window Replacement Fort Worth TX | Professional Installation',
  description: 'Expert window replacement in Fort Worth, TX. Andersen, Pella & JELD-WEN authorized dealer. Serving all Fort Worth neighborhoods. Free estimate: 214-444-4444.',
  keywords: 'window replacement Fort Worth, Fort Worth windows, window installation Fort Worth TX',
}
