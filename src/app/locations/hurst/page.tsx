...
export const metadata: Metadata = {
  title: 'Window Replacement Hurst TX | Expert Window Services',
  description: 'Professional window replacement in Hurst, TX. Premium Andersen, Pella & JELD-WEN windows. Serving all Hurst neighborhoods. Call 214-444-4444 for free estimate.',
  keywords: 'window replacement Hurst TX, Hurst windows, window installation Hurst, replacement windows Texas',
}

export default function HurstPage() {
  const content = {
    intro: 'Hurst stands as a cornerstone mid-cities community—a family-oriented city where neighborhood stability and small-town values thrive within the Dallas-Fort Worth metroplex. From established neighborhoods near Chisholm Park to homes throughout this tight-knit 9.8-square-mile city, Hurst properties reflect decades of careful homeownership. Our window replacement services support this tradition of property stewardship, delivering quality installations that improve comfort, reduce energy costs, and maintain home values through every Texas season.',
    ...
    commitment: 'Hurst built its reputation as a great place to raise families and build lasting community connections. We share these values, treating every customer relationship as long-term rather than transactional. We communicate honestly about project details, timelines, and costs. We work safely and cleanly, important when families and pets are present. We stand firmly behind our installations, responding promptly when warranty service is needed. Hurst deserves window replacement services as reliable and trustworthy as the community itself, and delivering exactly that remains our constant commitment.',
  }
