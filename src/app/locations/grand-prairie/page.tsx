...
export const metadata: Metadata = {
  title: 'Window Replacement Grand Prairie TX | Expert Installation',
  description: 'Top-rated window replacement in Grand Prairie, TX. Andersen, Pella & JELD-WEN windows. Serving all Grand Prairie areas. Free estimate: 214-444-4444.',
  keywords: 'window replacement Grand Prairie TX, Grand Prairie windows, window installation Grand Prairie',
}

export default function GrandPrairiePage() {
  const content = {
    intro: 'Grand Prairie bridges the Dallas-Fort Worth metroplex both geographically and culturally—a diverse, growing community where longtime residents and new arrivals build futures together. From established neighborhoods surrounding Mountain Creek Lake to newer developments spreading westward, Grand Prairie homes reflect practical Texas sensibility combined with modern expectations for comfort and efficiency. Our window replacement services honor this balance, delivering quality installations that enhance both your home\'s appearance and its year-round livability.',
