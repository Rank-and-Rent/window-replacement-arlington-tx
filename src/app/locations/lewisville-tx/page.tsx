...
export const metadata: Metadata = {
  ...
  description: 'Professional window replacement in Lewisville, TX. Premium Andersen, Pella & JELD-WEN windows. Serving all Lewisville areas. Call 817-592-8870 for free estimate.',
