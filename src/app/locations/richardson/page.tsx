...
export const metadata: Metadata = {
  ...
  description: 'Quality window replacement in Richardson, TX. Andersen, Pella & JELD-WEN windows. Serving all Richardson areas. Free consultation: 214-444-4444.',
