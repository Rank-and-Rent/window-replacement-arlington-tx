...
export const metadata: Metadata = {
  title: 'Window Replacement Bedford TX | Professional Installation',
  description: 'Quality window replacement in Bedford, TX. Andersen, Pella & JELD-WEN windows. Serving all Bedford areas. Free consultation: 214-444-4444.',
  keywords: 'window replacement Bedford TX, Bedford windows, window installation Bedford, energy efficient windows',
}

export default function BedfordPage() {
  const content = {
    intro: 'Bedford epitomizes mid-cities living at its finest—a well-established community where tree-lined streets, excellent parks, and strong neighborhood pride create an enviable quality of life. From the historic homes near Old Bedford Road to the well-maintained neighborhoods throughout this compact city, Bedford properties reflect homeowners\' commitment to preservation and improvement. Our window replacement services honor this dedication, providing installations that enhance both comfort and curb appeal while respecting each home\'s architectural character.',
