...
export const metadata: Metadata = {
  title: 'Window & Door Replacement Mansfield TX | Quality Installation Services',
  description: 'Professional window and door replacement in Mansfield, TX. Premium Andersen, Pella, JELD-WEN, Marvin windows. Serving all Mansfield areas. Free consultation: 817-592-8870.',
  keywords: 'window and door replacement Mansfield TX, Mansfield windows, window installation Mansfield, energy efficient windows',
}

export default function MansfieldPage() {
  const content = {
    intro: 'Mansfield embodies the best of suburban Texas living—master-planned communities with excellent schools, abundant parks, and strong neighborhood connections. From newer subdivisions expanding southward to established areas near historic downtown, Mansfield homes reflect families\' commitment to quality and long-term value. Our window and door replacement services align perfectly with these priorities, delivering installations that enhance comfort, reduce energy costs, and maintain your home\'s value for decades to come.',
