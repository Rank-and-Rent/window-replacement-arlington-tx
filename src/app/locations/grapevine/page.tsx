...
export const metadata: Metadata = {
  ...
  description: 'Expert window replacement in Grapevine, TX. Authorized Andersen, Pella & JELD-WEN dealer. Serving all Grapevine areas. Free estimate: 214-444-4444.',
  keywords: 'window replacement Grapevine TX, Grapevine windows, window installation Grapevine, historic window restoration',
}
...
export default function GrapevinePage() {
  const content = {
    ...
    commitment: 'Grapevine\'s identity centers on maintaining high standards—in historic preservation, community development, and quality of life. We embrace identical principles in window replacement. Our work respects your home\'s architectural integrity while improving its performance. Our communication reflects Grapevine\'s culture of professionalism and courtesy. Our warranties provide genuine protection, backed by our commitment and manufacturers\' reputations. Whether your project involves replicating windows for a century-old Victorian or installing contemporary units in a new lakefront home, you receive the same meticulous attention to detail and commitment to excellence Grapevine demands.',
  }
