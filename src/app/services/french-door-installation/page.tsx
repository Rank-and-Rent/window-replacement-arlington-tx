...
export const metadata: Metadata = {
  ...
  description: 'Professional French door installation in Arlington, TX. Classic elegance with glass panels. Interior and exterior installations. Andersen, Pella, JELD-WEN, Marvin. Call 214-444-4444.',
