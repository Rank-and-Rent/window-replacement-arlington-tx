...
export const metadata: Metadata = {
  ...
  description: 'Professional custom door installation in Arlington, TX. One-of-a-kind designs built to your exact specifications. Premium materials, expert craftsmanship. Call 214-444-4444 for consultation.',
