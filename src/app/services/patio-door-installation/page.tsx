...
export const metadata: Metadata = {
  ...
  description: 'Professional patio door installation in Arlington, TX. Sliding and hinged patio doors from Andersen, Pella, JELD-WEN, and Marvin. Energy-efficient, beautiful, secure. Free estimates. Call 214-444-4444.',
