...
export const metadata: Metadata = {
  ...
  description: 'Professional storm door installation in Arlington, TX. Protect your entry door and boost energy efficiency. Retractable screens, security options. Free estimates. Call 214-444-4444.',
